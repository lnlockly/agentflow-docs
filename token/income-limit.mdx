...
This is the second core protective mechanic of the `dpnm` template (the first is the [daily buy limit](/token/buy-sell#daily-buy-limit)).
...
See [GWT](/token/gwt) for the full redemption flow.
