...
LaunchpadFactory address on BSC testnet: [`0x713d...1920`](https://testnet.bscscan.com/address/0x713d03A57f9e2c5A526D0C5177342e9417841920). See [Deployments](/onchain/deployments) for the full address list including template implementations.
...
<CardGroup cols={2}>
  ...
  <Card title="Onchain architecture" icon="link" href="/onchain/overview">
