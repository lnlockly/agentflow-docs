...
## Payout split per extend (re-stated from [Phenomenal tree](/token/phenomenal-tree))
...
- [Phenomenal tree](/token/phenomenal-tree) — the structural details.
- [GWT](/token/gwt) — what to do with the GWT you accumulate from extends.
