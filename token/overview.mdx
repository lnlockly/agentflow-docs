...
Full list: [Deployments](/onchain/deployments).
...
See [Buy / Sell](/token/buy-sell) for the full transaction flow, [Income limit](/token/income-limit) for the burn math, [Phenomenal tree](/token/phenomenal-tree) for ancestor payouts, and [GWT](/token/gwt) for redemption.
