...
- [Extend tree](/token/extend-tree) — the activation and extension flow.
- [Income limit](/token/income-limit) — how earnings affect your `1:2` cap.
- [Closed system](/concepts/closed-system) — why the tree exists at all.
