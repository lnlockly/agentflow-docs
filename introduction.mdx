...
<CardGroup cols={3}>
  ...
  <Card title="$FLOW token" icon="coins" href="/token/overview">
...
<CardGroup cols={2}>
  ...
  <Card title="Three pillars" icon="layers" href="/concepts/three-pillars">
...
<Note>
  AgentFlow is in active development on BSC testnet. Mainnet is gated behind a third-party audit. Always verify the addresses you interact with against [Deployments](/onchain/deployments).
</Note>
