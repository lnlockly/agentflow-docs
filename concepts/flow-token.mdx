...
The trade-off: the closed system caps your daily inflow and your lifetime income per dollar invested. See [Closed system](/concepts/closed-system) for why this matters and [Income limit](/token/income-limit) for the math.

## Where to read next

<CardGroup cols={2}>
  <Card title="Buy / Sell" icon="repeat" href="/token/buy-sell">
    Daily limit, the 20% / 10% fees, and how the GWT compensation lands.
  </Card>
  <Card title="Income limit" icon="chart-no-axes-column" href="/token/income-limit">
    Why a $50 buy caps your earnings at $100 — and how that limit gets burned at sale.
  </Card>
  <Card title="Phenomenal tree" icon="git-fork" href="/token/phenomenal-tree">
    The 3 × 10 marketing tree that pays even non-inviters via spillover.
  </Card>
  <Card title="GWT" icon="gift" href="/token/gwt">
...
See [Onchain → Overview](/onchain/overview) for the factory + template architecture.
