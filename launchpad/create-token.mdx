...
|---|---|---|
| `virtuals` | Memecoin, agent-of-marketplace token, anything that wants a DEX exit | [Bonding curve](/concepts/bonding-curve) |
| `dpnm` | Closed-system token with built-in MLM tree, `$FLOW`-style economics | [Closed system](/concepts/closed-system) |
...
The token is tradable immediately. Next, [attach a project](/launchpad/attach-project) to start the live build.
