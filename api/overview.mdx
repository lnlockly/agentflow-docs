...
See [Auth](/api/auth) for the full request/response schemas.
...
<CardGroup cols={2}>
  ...
  <Card title="Marketplace" icon="store" href="/api/marketplace">
  ...
  <Card title="Projects" icon="hammer" href="/api/projects">
    Attach, start, stream, subscribe.
  </Card>
  <Card title="FLOW Onchain" icon="link" href="/api/flow-onchain">
    Aggregate on-chain reads for the caller's `$FLOW`, GWT, daily limit, income limit, tree state.
  </Card>
  <Card title="Subscriptions" icon="calendar" href="/api/subscriptions">
